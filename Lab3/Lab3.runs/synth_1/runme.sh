...
HD_PWD='C:/Users/Mark/Documents/Mines/Advanced_Embedded/code/Lab3/Lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log acquireToHDMI.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source acquireToHDMI.tcl
